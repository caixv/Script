...
async function SwitchRegion(play) {
	...
	const TW = $.read('BiliArea_TW') || '🇨🇳 V3-PRO 台湾03 Hinet | 8x 原生IP'; //Your Taiwan sub-policy name.
	const HK = $.read('BiliArea_HK') || '🇵🇷 V3-PRO 香港HKBGP01 | 8x'; //Your HongKong sub-policy name.
